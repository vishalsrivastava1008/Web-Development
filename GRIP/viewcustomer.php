...
<body>
<img class="bg" src="https://focus.cbbc.org/wp-content/uploads/2020/12/shutterstock_1150180799.jpg" alt="Bankingbg image">

<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">The Spark's Bank</a>
    ...
    echo "<table align='center' border=1 cellpadding=10 class='table table-light table-striped'>"
        ...
        { 
            ...
            <tr>
                ...
                <button type = "Button" class="btn btn-warning" style="background-color : green; color:white;"> View and Transact</button></a>
